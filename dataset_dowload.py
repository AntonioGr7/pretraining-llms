...
shard_size = int(1e8) #1e8 100M tokens per shard

DATA_CACHE_DIR = os.path.join(os.path.dirname(__file__), local_dir)
os.makedirs(DATA_CACHE_DIR, exist_ok=True)

# Add here other data_files if you want to extend the training to more tokens
data_files = ["it/it_part_00000.parquet","it/it_part_00001.parquet","it/it_part_00002.parquet","it/it_part_00003.parquet"]
